    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="loginregistro/index.php"> Iniciar Sesión </a>
                <a class="navbar-brand" href="loginregistro/index.php"> Registrarse </a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">TOOL STORE</h1>
                <p class="lead fw-normal text-white-50 mb-0">LO MEJOR EN HERRAMIENTAS.</p>
            </div>
        </div>
    </header>
    <section class="py-5">
